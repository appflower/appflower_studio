 ...
 * @author     Radu Topala
 */
class afsInsertSqlDiffTask extends sfPropelBaseTask
{
  /**
   * @see sfTask
   */
...
The [afs:insert-sql-diff|INFO] compares the current database structure and the
available schemas. If there is a difference, it creates a sql diff file and insert the sql diff into db:

  [./symfony afs:insert-sql-diff|INFO]
