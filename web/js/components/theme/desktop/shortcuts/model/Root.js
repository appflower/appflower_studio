 ...
 */
afStudio.theme.desktop.shortcut.model.Root = Ext.extend(afStudio.theme.desktop.shortcut.model.Node, {
    ...
    constructor : function(config) {
        afStudio.theme.desktop.shortcut.model.Root.superclass.constructor.call(this, config);
    ...
    initStructure : function(strc) {
        ...
        if (strc) {
            strc = Ext.isFunction(strc) ? strc : afStudio.theme.desktop.shortcut.model.template[strc];
        } else if (mt) {
            var sTpl = mt.ucfirst() + 'Template';
            strc = afStudio.theme.desktop.shortcut.model.template[sTpl];
        }
