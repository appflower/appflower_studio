...
/**
 * Shortcut editor's InspectorTree.
 * @author Nikolai Babinski <niba@appflower.com>
 */
afStudio.theme.desktop.shortcut.view.inspector.InspectorTree = Ext.extend(afStudio.view.inspector.InspectorTree, {
    ...
    _beforeInitComponent : function() {
        var root = this.controller.getRootNode(),
            ns = afStudio.theme.desktop.shortcut.view.inspector;
...
afStudio.theme.desktop.shortcut.view.inspector.nodeType = {}