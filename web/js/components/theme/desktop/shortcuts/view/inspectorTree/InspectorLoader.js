Ext.ns('afStudio.theme.desktop.shortcut.view.inspector');

/**
 * Shortcut InspectorTree loader.
 * @class afStudio.theme.desktop.shortcut.view.inspector.InspectorLoader
 * @extends afStudio.view.inspector.InspectorLoader
 * @author Nikolai Babinski
 */
afStudio.theme.desktop.shortcut.view.inspector.InspectorLoader = Ext.extend(afStudio.view.inspector.InspectorLoader, {
    ...
    resolveNodeType : function(type) {
        var nCls   = String(type).trim().ucfirst(),
            nodeNs = [afStudio.theme.desktop.shortcut.view.inspector.nodeType];
