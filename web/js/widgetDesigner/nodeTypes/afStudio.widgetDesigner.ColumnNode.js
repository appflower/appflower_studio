 ...
 * So Column node contains valueType and valueSource properties and based on their values
...
afStudio.widgetDesigner.ColumnNode = Ext.extend(afStudio.widgetDesigner.ContainerNode, {
    ...
    ,dumpDataForWidgetDefinition: function(){
        var widgetData = afStudio.widgetDesigner.ColumnNode.superclass.dumpDataForWidgetDefinition.apply(this, arguments);
        var newWidgetData = {};
        for (i in widgetData) {
            if (i == 'valueType') {
    ...
    ,propertyChanged: function(property){
        afStudio.widgetDesigner.ColumnNode.superclass.propertyChanged.apply(this, arguments);
    ...
    ,configureFor: function(widgetData){
        afStudio.widgetDesigner.ColumnNode.superclass.configureFor.apply(this, [widgetData]);
